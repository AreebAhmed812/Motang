                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-inner">
                                {!! Form::model($modelManagements, ['route' => $section->route, 'class' => 'form-validate',
                                'autocomplete' => 'off']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                {!! Form::select('make_brand', \App\Models\brand::pluck('brand_name',
                                                'id'), null, ['class' => 'form-control', 'placeholder' =>
                                                'Select a Make/Brand', 'required' => 'required', $disabled]) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                => 'Enter a Model', 'required' => 'required', $disabled , ]) !!}
                                            </div>
                                        </div>
                                    </div>
