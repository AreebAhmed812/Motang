                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-inner">
                                {!! Form::model($brands, ['route' => $section->route, 'class' => 'form-validate',
                                'autocomplete' => 'off']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                {!! Form::text('brand_name', null, ['class' => 'form-control', 'placeholder'
                                                => 'Enter a Brand Name', 'required' => 'required', $disabled , ]) !!}
                                            </div>
                                        </div>
                                    </div>
