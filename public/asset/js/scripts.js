(function ($) {
	...
	$(document).ready(function () {
		...
		function customFuction(){
		   // Initially hide the grid or list based on your HTML structure
		$('.listings-grid.clearfix.search-page').css('display', 'none !important');
		console.log('hide hai');
		$('a.grid').click(function() {
			console.log('han');
			$('.search-page').css('display', 'flex');
			$('.listings-list').css('display', 'none');
		});
		
		$('a.list').click(function() {
			$('.listings-list').css('display', 'block');
